...
const translations: Record<string, string> = {
  ...
  "Se connecter":"Log in",
  "Gestion intelligente des présences":"Smart attendance management",
  ...
  "Vue d’ensemble de votre gestion des présences.":"Overview of your attendance management.",
  "Session active":"Active session",
  "Super Administrateur":"Super Administrator",
  "Organisations":"Organizations",
  "Administrateurs actifs":"Active administrators",
  "Pointages aujourd’hui":"Today's check-ins",
  "Accès rapides":"Quick access",
  "Créer, superviser et supprimer les organisations.":"Create, supervise and delete organizations.",
  "Gérer les comptes administrateurs.":"Manage administrator accounts.",
  "Consulter les pointages.":"View attendance records.",
  "Paramètres":"Settings",
  "Configurer le GPS et les horaires.":"Configure GPS and schedules.",
  "Personnel actif":"Active personnel",
  "Présents":"Present",
  "Retards":"Late",
  "Absents":"Absent",
  "employés / utilisateurs":"employees / users",
  "pointages à l’heure":"on-time check-ins",
  "pointages en retard":"late check-ins",
  "sans pointage aujourd’hui":"no check-in today",
  "Suivi des présences":"Attendance tracking",
  "personne(s) ont déjà pointé aujourd’hui.":"person(s) have already checked in today.",
  "Déconnexion":"Log out",
  "Présence enregistrée":"Attendance recorded",
  "GPS ACTIF":"GPS ACTIVE",
  "Position vérifiée · 50 m":"Location verified · 50 m",
  "PERSONNES":"PEOPLE",
  "Aujourd’hui · 08:02":"Today · 08:02",
  ...
  "E-mail *":"Email *",
  "Téléphone":"Phone",
  "Matricule / identifiant":"ID / identifier",
  "Classe *":"Class *",
  "Fonction / profil":"Role / profile",
  "Mot de passe *":"Password *",
  "Confirmer le mot de passe *":"Confirm password *",
  "Créer l’administrateur":"Create administrator",
  "Modifier":"Edit",
  "Supprimer":"Delete",
  "Actif":"Active",
  "Inactif":"Inactive",
  ...
  "Votre organisation mérite un suivi simple et efficace.":"Your organization deserves simple and efficient tracking.",
  "Organisation":"Organization",
  "Organisations enregistrées":"registered organizations",
  "comptes administrateurs":"administrator accounts",
  "pointages enregistrés":"attendance records",
  "employés":"employees",
  "utilisateurs":"users",
  "aujourd’hui":"today",
  "Aujourd’hui":"Today",
  ...
  "Lieu et horaires de pointage":"Attendance location and schedule",
  ...
  "Heure de départ":"End time",
  "Délai de tolérance":"Grace period",
  ...
  "Compte créé avec succès. Vous pouvez maintenant vous connecter.":"Account created successfully. You can now log in.",
  ...
  "Organisation supprimée.":"Organization deleted.",
  "Administrateur supprimé.":"Administrator deleted.",
  "Absent":"Absent",
  "Marquer ma présence":"Check in",
  "Marquer mon départ":"Check out",
  "Ma présence":"My attendance",
  "Déjà pointé":"Already checked in",
  "Départ enregistré":"Check-out recorded",
  "Arrivée enregistrée":"Check-in recorded",
  "Hors zone GPS":"Outside GPS area",
  "Vous êtes dans la zone autorisée.":"You are within the allowed area.",
  "Vous devez être dans la zone autorisée pour pointer.":"You must be within the allowed area to check in.",
  "Pointage":"Check-in",
  "Distance":"Distance",
